 ...
 */
?>
<!-- documentations which was submitted by teamates -->
<table border="0" cellspacing="0" cellpadding="5" class="docTable">
	...
	<tr>
		...
		<td align="center"><span><?php echo $row['uploader'];?></span></td>
		...
		<?php if($role == '1' && $row['docStatusId'] == '0'){?>
			<table width="64" border="0">
				<tr>
					...
					<td width="32"><input type="button" class="docPass" value="通过" /></td>
					<td width="32"><input type="button" class="docDeny" value="拒绝" /></td> 
				--></tr>
			</table>
		<?php }?>
		</td>
